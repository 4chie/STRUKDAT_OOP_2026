...
Pada project ini, terdapat penggunaan konsep dasar OOP yang biasa disebut **4 Pillars of OOP**, yaitu:

1. **Encapsulation**

Encapsulation adalah konsep menyembunyikan data di dalam class dan membatasi akses langsung terhadap data tersebut. Pada program ini, atribut pada class *mobil* dibuat menggunakan access modifier private sehingga tidak dapat diakses langsung dari luar class.

2. **Abstraction**

Abstraction adalah konsep menyederhanakan sistem dengan hanya menampilkan fungsi yang penting kepada pengguna. Dalam program ini, *mobil* memiliki method yang merepresentasikan perilaku *mobil* seperti melakukan akselerasi.
